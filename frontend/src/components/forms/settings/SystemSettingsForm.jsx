    ...
    <Stack gap="md">
      ...
      {!isModular && (
        <>
          <Select
            label="Log Level"
            description="Minimum level kept in the log file and container output, applied instantly. The container default follows DISPATCHARR_LOG_LEVEL; levels below it are never generated by the application."
